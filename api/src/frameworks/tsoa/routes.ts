...
const models: TsoaRoute.Models = {
    ...
    "GetUserOutfitDetailsOutputDto": {
        ...
        "properties": {
            "uuid": {"dataType":"string","required":true},
            "name": {"dataType":"string","required":true},
            "garments": {"dataType":"nestedObjectLiteral","nestedProperties":{"shoes":{"dataType":"union","subSchemas":[{"ref":"GarmentInterface"},{"dataType":"enum","enums":[null]}],"required":true},"bottom":{"dataType":"union","subSchemas":[{"ref":"GarmentInterface"},{"dataType":"enum","enums":[null]}],"required":true},"subTop":{"dataType":"union","subSchemas":[{"ref":"GarmentInterface"},{"dataType":"enum","enums":[null]}],"required":true},"mainTop":{"dataType":"union","subSchemas":[{"ref":"GarmentInterface"},{"dataType":"enum","enums":[null]}],"required":true}},"required":true},
